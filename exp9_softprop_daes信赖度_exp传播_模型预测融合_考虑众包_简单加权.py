"""
python exp9_softprop_daes信赖度_exp传播_模型预测融合_考虑众包_简单加权.py \
    --dataset Treeversity \
    --lpi 3 \
    --out ./topology_daes \
    --exp_name exp9_softprop_daes信赖度_exp传播_模型预测融合_考虑众包_简单加权/Treeversity/lr0.01LPI3_Run_1del1_top_top_lsr0.0_k_15_new \
    --network R50 \
    --epochs 100 \
    --batch_size 32 \
    --lr 0.05 \
