...
python 结合投影_众包.py \
    ...
    --lpi 10 \
    --out ./topology_daes \
    --exp_name 结合投影_众包/Treeversity/LPI10_Run_1del1_exp_top \
    --network R50 \
    --epochs 100 \
    --batch_size 32 \
    --lr 0.05 \
...
python 结合投影_众包.py \
    ...
    --lpi 10 \
    --out ./topology_daes \
    --exp_name 结合投影_众包/Benthic/LPI10_Run_1del1_top_daes_top_daesdel_1.0_lsr0.0_不与众包先验融合 \
    --network R50 \
    --epochs 100 \
    --batch_size 32 \
    --lr 0.05 \
    ...
    --lr_decay_rate 0.2 \
    --seeds 1 2 3 \
    --detailed_log    --cuda_dev 1  --history_len 15
...
def reliable_pseudolabel_selection_advanced(logger, args, device, trainloader, features, epoch, 
    ...
    neighbor_model_labels = model_hard_labels[neighbors_mh[:, 1:]]
